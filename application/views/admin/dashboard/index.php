        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between pb-4">
                    <p class="card-description mb-0 d-none d-sm-block">Activity from 4 Jan 2017 to 10
                        Jan 2017</p>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="<?= base_url() ?>assets/admin/images/faces/face4.jpg" alt="">
                ...
                <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="<?= base_url() ?>assets/admin/images/faces/face5.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                        <p class="mb-0">
                ...
                <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="<?= base_url() ?>assets/admin/images/faces/face7.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                        <p class="mb-0">
                ...
                <div class="list d-flex align-items-center pt-3">
                    <img class="img-sm rounded-circle" src="<?= base_url() ?>assets/admin/images/faces/face6.jpg" alt="">
                    <div class="wrapper w-100 ml-3">
                        <p class="mb-0">
                            <b>Natalia </b>posted in Material
                        </p>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">That's awesome!</p>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive support-pane no-wrap">
                    <div class="t-row">
                        <div class="tumb">
                            <div
                                class="img-sm rounded-circle bg-info d-flex align-items-center justify-content-center text-white">
                                EC</div>
                        </div>
                        <div class="content">
                    ...
                    <div class="t-row">
                        <div class="tumb">
                            <div
                                class="img-sm rounded-circle bg-danger d-flex align-items-center justify-content-center text-white">
                                EC</div>
                        </div>
                        <div class="content">
                    ...
                    <div class="t-row">
                        <div class="tumb">
                            <div
                                class="img-sm rounded-circle bg-success d-flex align-items-center justify-content-center text-white">
                                EC</div>
                        </div>
                        <div class="content">

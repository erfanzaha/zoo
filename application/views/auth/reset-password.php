...
<div class="col-12 col-md-8 h-100 bg-white">
    <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
        ...
        <form method="post" id="form-data" class="account-create">
            <h3 class="mr-auto">Reset Password</h3>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input class="form-control input-lg" type="password" name="r_newpass" id="password"
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input class="form-control input-lg" type="password" name="confirm_password" id="confirm_password"
